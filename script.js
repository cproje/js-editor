(function () {
  ...
  function update() {
    _output.innerHTML = _input.value
      .replace(/</g, '&lt;')
      .replace(/>/g, '&gt;')
      .replace(/\b(await|break|case|catch|class|const|continue|debugger|default|delete|do|else|enum|export|extends|false|finally|for|function|if|implements|import|in|instanceof|interface|let|new|null|of|package|private|protected|public|return|super|switch|static|this|throw|try|True|typeof|var|void|while|with|yield)\b/g, '<span class="keyword">$1</span>')
  ...
  function view(obj, tabSize) {
    ...
    switch (typeof obj) {
      ...
      case 'function':
        return `<span class="keyword">function</span> ${obj.name}`;
